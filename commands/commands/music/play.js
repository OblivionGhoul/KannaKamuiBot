...
module.exports = {
    ...
    callback: async (message, args) => {
        ...
        if (!searchString) return sendError("Please provide what you want me to play.", message.channel);
        ...
        if (url.match(/^(https?:\/\/)?(www\.)?(m\.)?(youtube\.com|youtu\.?be)\/.+$/gi)) {
            try {
                ...
                if (!songInfo) return sendError("Unable to find the song on YouTube", message.channel);
                song = {
            ...
            try {
                ...
                if (searched.videos.length === 0) return sendError("Unable to find the song on YouTube", message.channel)
