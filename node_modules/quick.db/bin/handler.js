 ...
 */
 ...
 /**
 * This function enables/disables Write-Ahead Logging based on the given boolean 
 * @param {boolean} toggle WAL mode. 
 */
 wal: function(toggle) {
    if (typeof toggle !== 'boolean') throw new TypeError('No boolean specified. Need Help? Check Out: discord.gg/plexidev');
    else if (toggle) return (!!db.pragma('journal_mode = WAL'));
    else return (!!db.pragma('journal_mode = DELETE'));
 },
 ...
 */
  ...
  /* this.all() with extra features */
  startsWith: function(str, ops) {
    return arbitrate('startsWith', {str: str, ops: ops || {}}); 
  },
 ...
 */
  ...
  table: function(tableName, options = {}) {
    ...
    this.startsWith = function(str, ops) {
      return arbitrate('startsWith', {ops: ops || {}}, this.tableName); 
    }
